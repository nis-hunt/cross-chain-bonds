...
abstract contract FrontEndRewarder is DEPOAccessControlled {
    /* ========= STATE VARIABLES ========== */
    ...
    IERC20 internal immutable depo; // reward token

    constructor(IDEPOAuthority _authority, IERC20 _depo) DEPOAccessControlled(_authority) {
        depo = _depo;
    }
    ...
    function getReward() external {
        ...
        depo.transfer(msg.sender, reward);
    }
